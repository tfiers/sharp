"""
Trained neural networks, stored on disk.
Also: architecture of the recurrent neural network.
"""
...
from sharp.data.types.aliases import NeuralModel, TorchArray
...
class RNN(NeuralModel):
    ...
    def __init__(
        ...
        self.h2o = Linear(in_features=num_units_per_layer, out_features=1)
        log.debug(f"Initalised neural net {self}")
    ...
    def get_init_h(self, num_batches: int = 1) -> TorchArray:
        """
    ...
    def forward(
        self, x: TorchArray, h0: TorchArray
    ) -> (TorchArray, TorchArray):
        """
